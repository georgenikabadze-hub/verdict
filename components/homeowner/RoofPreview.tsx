...
export function RoofPreview({ coords, address }: Props) {
  ...
  if (!coords || !apiKey) {
    // Default illustrative SVG placeholder
    return (
  ...
  // Google Maps Static API — satellite view at the user's actual roof
  // 640x640 max size, scale=2 → retina, zoom=20 → individual buildings
  ...
  return (
    <div className="absolute inset-0">
      ...
      <img
        src={src}
        alt={address ? `Aerial view of ${address}` : "Aerial view of your address"}
